...
from .views import AgentListCreateAPIView, AgentDetailAPIView,AgentDeleteApiView,CampaignRetrieveUpdateAPIView,CampaignListCreateAPIView,CampaignResultListCreateAPIView,CampaignResultRetrieveUpdateAPIView,RegisterAPIView,LogoutAPIView,CampaignResultDeleteAPIView,CampaignDeleteAPIView
